...
const DEFAULT_BASE_URL = 'https://v2.backendeventoscfb.cafebugado.com.br'
...
// GET na API dedicada de eventos (v2.backendeventoscfb.cafebugado.com.br).
...
// atual, igual ao comportamento anterior via Supabase. Passe `next: {
// revalidate }` pra rotas que toleram cache (ex.: sitemap.js) — nesse caso
// `cache: 'no-store'` é omitido, já que os dois são mutuamente exclusivos.
