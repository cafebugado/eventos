...
function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/company/cafebugado',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
    ...
    {
      name: 'WhatsApp',
      url: 'https://chat.whatsapp.com/CSma4uQURpSFsTpQSS6m9V',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
